  ...
  const handleAddSubmit = (e: React.FormEvent) => {
    ...
    if (activeMenu === 'kasus') {
      if (!caseName.trim() || !caseResolution.trim()) {
        alert('Harap isi semua kolom kasus.');
        return;
      }
      onAddCase({
      ...
      if (!achName.trim() || !achDesc.trim()) {
        alert('Harap isi semua kolom prestasi.');
        return;
      }
      onAddAchievement({
        nisn: selectedStudentNisn,
                      ...
                      <td className="p-4 text-center">
                        <button
                          onClick={() => {
                            ...
                            alert('Pesan notifikasi terkait laporan kasus siswa berhasil ditransmisikan ke email orangtua!');
                          }}
                      ...
                      <td className="p-4 text-center">
                        <button
                          onClick={() => {
                            ...
                            alert('Pesan notifikasi terkait prestasi siswa berhasil dikirimkan ke email orangtua!');
                          }}
