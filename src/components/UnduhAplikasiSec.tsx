...
export default function UnduhAplikasiSec({ schoolName }: UnduhAplikasiSecProps) {
  ...
  const handleNativeInstall = async () => {
    if (deferredPrompt) {
      ...
      toast.warning('Fitur PWA native belum didukung penuh oleh sandbox iframe browser Anda. Silakan ikuti panduan manual di bawah ini yang dijamin 100% berhasil!');
    }
  };
